...
type HttpError struct {
	Code int `datatype:"code" msgpack:"code"`
	Message string `datatype:"message" msgpack:"message"`
	Errors map[string][]string `datatype:"errors,omitempty" msgpack:"errors,as_array,omitempty"`
}
